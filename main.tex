...
\usetheme[
    ...
    %% Colors
    usematerialcolors, % Material color default colorschemes, disable with nomaterialcolors
    usettlabcolors, % Goethe University corporate & TTLab colors, disable with nottlabcolors
    noalphabetcolors, % Alphabet color scheme, enable with usealphabetcolors, REQUIRES CITATION
    nogreenarmytagecolors, % Green-Armytage color scheme, enable with usegreenarmytagecolors, REQUIRES CITATION
    %% Layout options
